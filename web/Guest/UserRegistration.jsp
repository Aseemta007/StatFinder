    ...
    <form method="post" enctype="multipart/form-data" action="../Assets/ActionPages1/UserUploadAction.jsp">
      ...
      <div class="formbold-mb-3">
        ...
        <div class="gender-details">
          <input type="radio" name="txtgender" id="dot-1">
          <input type="radio" name="txtgender" id="dot-2">
          <input type="radio" name="txtgender" id="dot-3">
          <label for="txtgender" class="formbold-form-label">
          Gender
        </label>
          <div class="category">
            <label for="dot-1">
            <span class="dot one"></span>
            <span class="formbold-form-label">Male</span>
          </label>
          <label for="dot-2">
            <span class="dot two"></span>
            <span class="formbold-form-label">Female</span>
          </label>
          <label for="dot-3">
            <span class="dot three"></span>
            <span class="formbold-form-label">Other</span>
            </label>
          </div>
        </div>
