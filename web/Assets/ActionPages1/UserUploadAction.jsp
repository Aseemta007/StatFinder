...
//checking if request cotains multipart data
           ...
           //f_item=(FileItem)itr.next();
                ...
                {
                String str1 = "insert into tbl_user(user_name,user_contact,user_email,user_gender,user_dob,location_id,user_address,user_photo,user_password)"
                        + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + value[4] + "','"+ value[7] + "','" + value[8] +"','" + ph +  "','" + value[9] + "')";
