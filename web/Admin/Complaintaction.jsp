...
<html>
    ...
    <%        if (request.getParameter("btn_save") != null) {
            ...
            String upQry = "update tbl_complaint set complaint_reply_admin='" + request.getParameter("txt_reply") + "'where complaint_id='" + request.getParameter("hid") + "'";
                                    ...
                                    <table>
                                        <thead>
                                            <tr >
                                                ...
                                                <td align="center" scope="col">Shop Reply</td>
                                                <td align="center" scope="col">Action</td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <%                                                int i = 0;
                                                String selQry = "select * from tbl_complaint c inner join tbl_user co on co.user_id=c.user_id where complaint_reply_admin IS NULL";
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><%=rs.getString("complaint_reply")%></td>
                                                <td align="center"><a href="Complaintaction.jsp?up=<%=rs.getString("complaint_id")%>" >Reply</a> </td>
                                            </tr>
                                            <%                      }
                                    ...
                                    <table>
                                        <thead>
                                            <tr >
                                                ...
                                                <td align="center" scope="col">Date</td>
                                                <td align="center" scope="col">User</td>
                                                <td align="center" scope="col">Admin Reply</td>
                                                <td align="center" scope="col">Reply Date</td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <%                                                int j = 0;
                                                String selQry1 = "select * from tbl_complaint c inner join tbl_user co on co.user_id=c.user_id where complaint_reply_admin IS NOT NULL";
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><%=rs1.getString("complaint_reply_admin")%></td>
