<%-- 
    ...
    Created on : Jan 18, 2024, 12:03:11 PM
    Author     : ANANTHU
--%>
...
<html>
    ...
    <%  
       ...
       String pass ="";
       String sq = "select*from tbl_shop where shop_id ='"+session.getAttribute("shid")+"'";
       ResultSet rs = con.selectCommand(sq);
       rs.next();
       pass = rs.getString("shop_password");
       ...
       {      
        if(pass.equals(currentpsswd))
        {
            ...
            {
                String uq = "update tbl_shop set shop_password = '"+request.getParameter("txtnpsswd")+"'where shop_id = '"+session.getAttribute("shid")+"'";
